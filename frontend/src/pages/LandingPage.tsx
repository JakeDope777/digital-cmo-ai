...
const faqs = [
  {
    q: 'Do I need technical skills to use CMO AI Buddy?',
  ...
  },
  {
    ...
    a: 'General AI tools have no memory of your brand, no access to your live data, and no ability to execute actions. CMO AI Buddy connects to your actual marketing stack, remembers your history and goals across sessions, and returns execution-ready plans — not just text.',
  },
  {
...
export default function LandingPage() {
  ...
  const submitWaitlist = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setMessage('Unable to join waitlist at the moment. Email us at hello@digitalcmoai.com');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <section className="px-6 py-24">
        ...
        <div className="mt-12 flex justify-center">
          <div className="inline-flex items-center gap-3 rounded-2xl border border-orange-200 bg-orange-50 px-6 py-4 text-sm font-medium text-orange-900">
            ...
            CMO AI Buddy eliminates all three. Automatically. In real time.
          </div>
        </div>
      </section>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Every other AI tool forgets everything the moment you close the tab. CMO AI Buddy maintains a living, growing model of your business — so every interaction is smarter than the last.
              </p>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/4 overflow-hidden">
              <div className="grid grid-cols-3 border-b border-white/10 px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                ...
                <span className="text-center text-orange-400">CMO AI Buddy</span>
              </div>
              {[
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-400">
              Not a generic AI tool. CMO AI Buddy comes pre-loaded with industry-specific KPIs, workflows, compliance guardrails, and integration stacks — so you're operational on day one.
            </p>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-white px-6 py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-slate-900">CMO AI Buddy</p>
              <p className="text-xs text-slate-400">Digital CMO OS · v0.2.0</p>
            </div>
          </div>
