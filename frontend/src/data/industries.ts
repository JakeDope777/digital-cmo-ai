...
export const industries: Industry[] = [
  // 1 ─ E-commerce / DTC
  {
    ...
    heroSub: 'Stop guessing which SKU to promote, which audience to scale, and which creative to cut. Digital CMO AI reads your Shopify, ad accounts, and email flows — and tells you exactly what to do next.',
    color: 'bg-orange-500',
    colorHex: '#f97316',
    emoji: '🛒',
    stats: [
  ...
  // 2 ─ SaaS / B2B
  {
    ...
    heroSub: 'Pipeline, activation, and expansion — all in one brain. Digital CMO AI connects your CRM, paid channels, and product data to give your team the strategic clarity of a seasoned CMO without the headcount.',
    color: 'bg-blue-600',
    colorHex: '#2563eb',
    emoji: '⚡',
    stats: [
    ...
    quote: { text: 'Our first board deck built with Digital CMO AI took 45 minutes instead of two days. The narrative structure it suggested was better than what we\'d written manually.', author: 'Jordan P.', role: 'CMO, Series A SaaS' },
  },
  ...
  // 3 ─ Fintech
  {
    ...
    heroSub: 'Compliance-aware marketing at the speed of fintech. Digital CMO AI generates copy that checks FCA/SEC guardrails, tracks activation funnels, and allocates budget across channels — without a legal review bottleneck.',
  ...
  // 8 ─ Marketing Agency
  {
    ...
    heroHeadline: 'The AI CMO built for\nmarketing agencies.',
    heroSub: 'Manage 10 client campaigns with the insights of 100 analysts. Digital CMO AI generates pitch decks, campaign reports, creative briefs, and strategic recommendations — so your team spends time on strategy, not slides.',
    color: 'bg-rose-600',
    colorHex: '#e11d48',
    emoji: '🏢',
    stats: [
